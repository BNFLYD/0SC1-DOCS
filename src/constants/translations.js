export const translations = {
  es: {
    ...
    aboutPage: {
      ...
      experience: {
        ...
        paragraphs: [
          "Con más de 5 años de experiencia en desarrollo web, he participado en diversos proyectos que han enriquecido mi perfil profesional.",
          "Mi trayectoria incluye el desarrollo de aplicaciones web escalables, implementación de arquitecturas robustas y optimización de rendimiento en proyectos de alto impacto."
        ]
      },
      muttForm: {
  ...
  en: {
    ...
    aboutPage: {
      ...
      experience: {
        title: "bat experience.md",
        paragraphs: [
          "With 5+ years of web development experience, I've contributed to diverse projects that shaped my professional profile.",
          "My journey includes building scalable web apps, implementing robust architectures, and optimizing performance on high‑impact projects."
        ]
      },
      muttForm: {
  ...
  de: {
    ...
    aboutPage: {
      ...
      experience: {
        title: "bat experience.md",
        paragraphs: [
          "Mit über 5 Jahren Erfahrung habe ich an vielfältigen Webprojekten gearbeitet, die mein Profil geprägt haben.",
          "Dazu zählen skalierbare Web‑Apps, robuste Architekturen und Performance‑Optimierung in Projekten mit großer Wirkung."
        ]
      },
      muttForm: {
  ...
  ja: {
    ...
    aboutPage: {
      ...
      contact: { title: "連絡先", email: "メール", linkedin: "LinkedIn", github: "GitHub" },
      skills: {
        title: "htop skills",
      ...
      experience: {
        title: "bat experience.md",
        paragraphs: [
          "5年以上のWeb開発経験を持ち、多様なプロジェクトに携わってきました。",
          "スケーラブルなWebアプリの構築、堅牢なアーキテクチャの実装、高負荷環境での最適化に取り組みました。"
        ]
      },
      muttForm: {
